    ...
    <div className="max-w-7xl mx-auto px-4 py-4 space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="relative rounded-3xl overflow-hidden bg-slate-950 border border-slate-800 shadow-2xl min-h-[75vh] flex flex-col justify-end p-4 group">
            ...
            {/* MINIMAL FLOATING TOP INFO STRIP — doesn't push layout height, video stays full-screen behind it */}
            <div className="absolute top-3 left-3 right-3 z-20 flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 bg-slate-950/60 backdrop-blur-md px-2.5 py-1.5 rounded-full border border-slate-700/60">
                <img
                  ...
                  referrerPolicy="no-referrer"
                />
                <span className="font-extrabold text-xs text-slate-100 pr-1">{selectedStream.creatorName}</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-2.5 py-1 bg-slate-950/60 backdrop-blur-md text-slate-200 text-[10px] font-bold rounded-full border border-slate-700/60 flex items-center gap-1">
                  👁️ {selectedStream.viewersCount.toLocaleString()}
                </span>
              </div>
            </div>

            {/* VERTICAL ICON RAIL — action buttons float on the right edge instead of cluttering the top */}
            <div className="absolute right-3 top-20 z-20 flex flex-col items-center gap-3">
              {isHost && (
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-slate-950/60 backdrop-blur-md hover:bg-slate-800 border border-slate-700/60 flex items-center justify-center transition-all disabled:opacity-50"
                >
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-slate-950/60 backdrop-blur-md hover:bg-purple-900/60 border border-slate-700/60 flex items-center justify-center shadow transition-all"
              >
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-gradient-to-br from-red-600 to-amber-500 flex items-center justify-center shadow-lg animate-bounce"
              >
                🧧
              </button>
              <button
                ...
                title="Mini Game"
                className="w-10 h-10 rounded-full bg-slate-950/60 backdrop-blur-md hover:bg-amber-900/40 border border-slate-700/60 flex items-center justify-center shadow transition-all"
              >
              ...
              <button
                ...
                className="relative w-10 h-10 rounded-full bg-slate-950/60 backdrop-blur-md hover:bg-cyan-900/40 border border-slate-700/60 flex items-center justify-center shadow transition-all"
              >
              ...
              <button
                ...
                title="Moderation"
                className="w-10 h-10 rounded-full bg-slate-950/60 backdrop-blur-md hover:bg-slate-800 border border-cyan-500/40 flex items-center justify-center shadow-lg transition-all"
              >
